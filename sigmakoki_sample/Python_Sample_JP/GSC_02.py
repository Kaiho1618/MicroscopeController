...
def click_Origin():
    ...
    if rtn == 0:
        axis = 'W'
        wdata = 'H:' + axis + direction + direction + '\r\n' 
    else:
        axis = str(rtn)       
        wdata = 'H:' + axis + direction + '\r\n' 
    print(wdata)
...
root = tk.Tk()
root.title("SIGMA-KOKI Python Sample for GSC-02")
...
rdo3 = tk.Radiobutton(value=0, variable=var, text='All')
...
var3 = tk.IntVar()
rdoP0 = tk.Radiobutton(value=1, variable=var3, text='+')
rdoM0 = tk.Radiobutton(value=2, variable=var3, text='-')
rdoP0.place(x=160, y=80)
rdoM0.place(x=200, y=80)
var3.set(1)
